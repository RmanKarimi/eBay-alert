...
This project is set up to run using [Docker Compose](https://docs.docker.com/compose/) by default. It is the recommended way.

1. Install Docker:
   - Linux - [get.docker.com](https://get.docker.com/)
   - Windows or MacOS - [Docker Desktop](https://www.docker.com/products/docker-desktop)
1. Clone this repo and `cd eBay-alert`
...
1. [Postgresql](https://www.postgresql.org/download/) as database
2. [Python](https://www.python.org/downloads/release/python-365/)
3. [Redis]() as cached server
4. [Celery]() as task scheduler

### Installation

1. Install [pipenv](https://pypi.org/project/pipenv/)
2. Clone this repo and `cd eBay-alert`
